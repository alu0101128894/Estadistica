...
#      dbinom(x, size, prob, log = FALSE)                         funci�n de densidad
#      pbinom(q, size, prob, lower.tail = TRUE, log.p = FALSE)    funci�n de distribuci�n
#      qbinom(p, size, prob, lower.tail = TRUE, log.p = FALSE)    cuantiles
#      rbinom(n, size, prob)                                      n�meros aleatorios   
...
punif(3, min=1, max=11)  # funci�n de distribuci�n en 3
visualize.unif(stat=3, a=1, b=11,section ="lower")
punif(3, min=1,max=11, lower.tail=FALSE)  # 1 - funci�n de distribuci�n en 8
